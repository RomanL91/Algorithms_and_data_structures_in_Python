...
# Стратегия создания простая: будет класс Узел, которому нужно 
# имя, а потом еще индекс присвоим и класс Граф, который при 
# инициализации будет создавать матрицу из переданного в конструктор
# списка экзепляров узлов.
# 
# Дам классу Граф метод для соединения узлов между собой с указанием
# "силы" связи. Этим получен неориентиованный взвешанный граф.
# 
# [
    # [0, 0, 0, 0], 
    # [0, 0, 0, 0], 
